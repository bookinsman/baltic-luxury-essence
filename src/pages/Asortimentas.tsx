...
const ProductSection: React.FC<{ title: string; products: typeof allProducts; introduction?: string }> = ({ title, products, introduction }) => (
  <section className="mb-20">
    <h2 className="text-4xl font-bold text-deep-navy dark:text-pearl mb-6 font-display border-l-4 border-rich-gold pl-4">
      {title}
    </h2>
    {introduction && (
      <p className="mb-8 text-lg text-charcoal/80 dark:text-platinum/80 font-light max-w-3xl">
        {introduction}
      </p>
    )}
...
const AsortimentasPage = () => {
  return (
    <div 
      className="min-h-screen bg-cream dark:bg-deep-navy text-charcoal dark:text-pearl"
      style={{
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <header className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-charcoal/80 dark:text-platinum/80 font-light max-w-3xl mx-auto mt-6">
